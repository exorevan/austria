  ...
  return (
    ...
    >
      <div className="modal-content bg-white rounded-xl overflow-hidden shadow-2xl max-w-xl w-[88%] relative transform transition-transform duration-300 scale-100" onClick={(e) => e.stopPropagation()}>
        <button onClick={onClose} aria-label="Закрыть" className="absolute top-3 right-3 p-2 rounded-full bg-white/80 hover:bg-white shadow dark:bg-slate-700/80 dark:hover:bg-slate-700 dark:text-slate-100 z-10">
