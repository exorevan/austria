...
const parksSlidesData = [
  {
    imgSrc: 'https://www.bauernhofurlaub.de/_Resources/Persistent/eab7a09b8e6c0b5af3f2a557bea0b0f8077d491a/AdobeStock_116790273.jpg?q=80&w=2070&auto=format&fit=crop', alt: 'Hoher Tauern',
    content: <>
      <h4 className="text-2xl font-bold mb-2">Hoher Tauern</h4>
      <p className="text-slate-600 mb-3">Крупнейший национальный парк Центральной Европы, охватывает земли Тироля, Каринтии и Зальцбурга.</p>
      <ul className="text-slate-600 list-disc list-inside space-y-1 text-sm">
        <li><strong className="text-slate-700">Гора:</strong> Гросглокнер (3798 м)</li>
        <li><strong className="text-slate-700">Ледник:</strong> Пастерце (~9 км, крупнейший в Австрии)</li>
        <li><strong className="text-slate-700">Водопады:</strong> Кримльские (общая высота ~380 м)</li>
      </ul>
    </>
  },
  {
    imgSrc: 'https://sb.ecobnb.net/app/uploads/sites/4/2023/04/Kalkalpen-840-%C3%97-490-px.jpg?q=80&w=2070&auto=format&fit=crop', alt: 'Kalkalpen',
    content: <>
      <h4 className="text-2xl font-bold mb-2">Kalkalpen</h4>
      <p className="text-slate-600 mb-3">Северный известняковый массив: один из крупнейших лесных массивов страны.</p>
      <ul className="text-slate-600 list-disc list-inside space-y-1 text-sm">
        <li><strong className="text-slate-700">Наследие ЮНЕСКО:</strong> древние буковые леса</li>
        <li><strong className="text-slate-700">Фауна:</strong> рыси, бурые медведи</li>
      </ul>
    </>
  },
  {
    imgSrc: 'https://cdn.indebergen.nl/media/ke1bbqlf/gesause.jpeg?q=80&w=2070&auto=format&fit=crop', alt: 'Gesäuse',
    content: <>
      <h4 className="text-2xl font-bold mb-2">Gesäuse</h4>
      <p className="text-slate-600 mb-3">Самый молодой нацпарк Штирии, известен драматичным карстовым рельефом.</p>
      <ul className="text-slate-600 list-disc list-inside space-y-1 text-sm">
        <li><strong className="text-slate-700">Река:</strong> ущелье, прорезанное рекой Энс</li>
        <li><strong className="text-slate-700">Вершина:</strong> Хохтор (2369 м)</li>
      </ul>
    </>
  },
  {
    imgSrc: 'https://files.bergwelten.com/t_image/c_fill,f_auto,w_2000,h_800/article/images/Donau-Auen2-Kovacs.jpg?q=80&w=2070&auto=format&fit=crop', alt: 'Donau-Auen',
    content: <>
      <h4 className="text-2xl font-bold mb-2">Donau-Auen</h4>
      <p className="text-slate-600 mb-3">Один из последних крупных пойменных ландшафтов Центральной Европы вдоль Дуная, возле Вены.</p>
      <ul className="text-slate-600 list-disc list-inside space-y-1 text-sm">
        <li><strong className="text-slate-700">Экосистема:</strong> богатое биоразнообразие пойменных лесов и водно-болотных угодий</li>
      </ul>
    </>
  },
  {
    imgSrc: 'https://archive.nationalparksaustria.at/pages/en/88/Unt-und-Ob-Stinkersee-Archiv-NP.jpg?q=80&w=2070&auto=format&fit=crop', alt: 'Neusiedlersee-Seewinkel',
    content: <>
      <h4 className="text-2xl font-bold mb-2">Neusiedlersee-Seewinkel</h4>
      <p className="text-slate-600 mb-3">Бургенланд. Биосферный заповедник ЮНЕСКО вокруг мелководного степного озера Нойзидлер-Зе.</p>
      <ul className="text-slate-600 list-disc list-inside space-y-1 text-sm">
        <li><strong className="text-slate-700">Орнитология:</strong> важнейший орнитологический центр Европы</li>
      </ul>
    </>
  },
  {
    imgSrc: 'https://www.nationalparksaustria.at/assets/images/5/thayatal_BR_NP_Thayatal_Mirau_web-659dba9c.jpg?q=80&w=2070&auto=format&fit=crop', alt: 'Thayatal',
    content: <>
      <h4 className="text-2xl font-bold mb-2">Thayatal</h4>
      <p className="text-slate-600 mb-3">Самый маленький национальный парк, расположен на границе с Чехией.</p>
      <ul className="text-slate-600 list-disc list-inside space-y-1 text-sm">
        <li><strong className="text-slate-700">Долина:</strong> живописная река Тайя</li>
        <li><strong className="text-slate-700">Биоразнообразие:</strong> высокая концентрация видов</li>
      </ul>
    </>
  },
];
...
const NaturePage = () => {
  return (
    <main className="px-5 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <section id="nature">
        <h2 className="section-title">Величественная Природа</h2>
        <p className="section-subtitle">Австрия неразрывно связана со своим природным ландшафтом, который формирует ее
          географию, национальный характер, экономику и образ жизни. В основе этого ландшафта лежат величественные
          Альпы.</p>
          ...
          <div className="card">
            ...
            <div className="p-8">
              ...
              <p className="text-slate-600 mb-4">Венец австрийских Альп, национальный символ и самая высокая точка
                ...
                наследия ЮНЕСКО.</p>
              <ul className="space-y-3 text-sm mt-6 border-t border-slate-200 pt-4">
                <li className="flex items-center"><svg xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-3 text-blue-500" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                    d="M4 6h16M4 12h16M4 18h7"></path>
                </svg><span className="font-semibold w-32 text-slate-500">Высота:</span> <strong
                  className="text-slate-700">3798 м</strong></li>
                <li className="flex items-center"><svg xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-3 text-blue-500" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                ...
                </svg><span className="font-semibold w-32 text-slate-500">Ледник:</span> <strong
                  className="text-slate-700">Пастерце</strong>, крупнейший в Австрии (длина ~9 км)</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          <ManualSlider slides={parksSlidesData} title="Национальные парки" />
        </div>
          ...
          <div className="card animated-card">
            ...
            <div className="p-6">
              ...
              <details className="mt-3">
                <summary className="cursor-pointer text-blue-600 hover:underline font-medium">Подробнее</summary>
                <ul className="text-slate-700 list-disc list-inside space-y-1 mt-2 text-sm">
                  <li>Экскурсия ~75 минут.</li>
                  <li>Около 1400 ступеней, температура ниже нуля круглый год.</li>
                  <li>Освещение историческими карбидными лампами.</li>
                </ul>
              </details>
            </div>
          </div>
          <div className="card animated-card">
            ...
            <div className="p-6">
              ...
              <details className="mt-3">
                <summary className="cursor-pointer text-blue-600 hover:underline font-medium">Подробнее</summary>
                <ul className="text-slate-700 list-disc list-inside space-y-1 mt-2 text-sm">
                  <li>Под водой оказываются тропинки, мосты и скамейки.</li>
                  <li>С 01.01.2016 любые водные активности (дайвинг, плавание и т. п.) запрещены.</li>
                  <li>Мера принята для сохранения хрупкой экосистемы.</li>
                </ul>
              </details>
            </div>
          </div>
          <div className="card animated-card">
            ...
            <div className="p-6">
              ...
              <p className="text-slate-600">Качество воды из альпийских источников настолько высоко, что она
                поступает из кранов практически в первозданном виде без обработки.</p>
            </div>
          </div>
        </div>
